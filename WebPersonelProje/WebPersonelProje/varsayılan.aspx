<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="varsayılan.aspx.cs"
    Inherits="WebPersonelProje.varsayılan" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/foti.png" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Ayşenur Demir</a></h1>
    ...
    <div class="main">
        <div class="banner-text-w3ls" id="home">
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="#about"
                        role="button">Hakkımda</a>
                </div>
            </div>
        </div>
        <!-- about -->
        ...
        <div class="news" id="news">
            <h3 class="w3_head mb-4 text-left">İŞ DENEYİMLERİ</h3>
            <p class="iner mt-md-5 text-left">
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınız" TextMode="MultiLine" Height="30">
                    </asp:TextBox>
